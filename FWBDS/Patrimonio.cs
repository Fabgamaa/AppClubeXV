    ...
    namespace FWBDS
{
    public class Patrimonio
    {
        ...
        public DataSet Consultar()
        {
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(PTR_UND)))
            {
                sCond = sCond + " PTR_UND = '" + PTR_UND + "' AND ";
            }
            if (!String.IsNullOrEmpty(Convert.ToString(PTR_LOC)))
            {
                sCond = sCond + " PTR_LOC = '" + PTR_LOC + "' AND ";
            }
            if (!String.IsNullOrEmpty(Convert.ToString(PTR_BEM)))
            {
                sCond = sCond + " PTR_BEM = '" + PTR_BEM + "' AND ";
            }
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(PTR_ETQ)))
            {
                sCond = sCond + " PTR_ETQ = '" + PTR_ETQ + "' AND ";
            }
            if (sCond != "")
            {
