...
public partial class _Default : System.Web.UI.Page
{
    ...
    protected void btProcurar_Click(object sender, EventArgs e)
    {
        ...
        if ((dsAfinidadeMedia.Tables[0].Rows.Count > 0))
        {
            ...
            //lbl_num.Text = dsAfinidadeMedia.Tables[0].Rows[0]["QTD"].ToString();

            //lbl_dat_min.Text = dsAfinidadeMedia.Tables[0].Rows[0]["DAT_MIN"].ToString().Substring(0, 10);
            //lbl_dat_max.Text = dsAfinidadeMedia.Tables[0].Rows[0]["DAT_MAX"].ToString().Substring(0, 10);
    ...
    protected void gvAfinidade_Sorting(Object sender, GridViewSortEventArgs e)
    {
        ...
        Afinidade Afinidade = new Afinidade();
        filtro = CriaFiltro(Afinidade);
        DataSet dsAfinidade = Afinidade.ConsultarMediaMensal();
    ...
    protected void ApresentaTipo()
    {
        ...
        if (cbo_tip_rel.SelectedValue == "1")
        {
            ...
            gvAfinidade.Columns[1].Visible = true;

            td_esu.Visible = true;
            td_esu_med.Visible = true;
            gvAfinidade.Columns[2].Visible = true;

            //td_tmt.Visible = true;
            //td_tmt_med.Visible = true;
            //gvAfinidade.Columns[3].Visible = true;

            //td_pmt.Visible = true;
            //td_pmt_med.Visible = true;
            //gvAfinidade.Columns[4].Visible = true;

            //td_ppf.Visible = true;
            //td_ppf_med.Visible = true;
            //gvAfinidade.Columns[5].Visible = true;

            //td_bbb.Visible = true;
            //td_bbb_med.Visible = true;
            //gvAfinidade.Columns[6].Visible = true;

            //td_pfe.Visible = true;
            //td_pfe_med.Visible = true;
            //gvAfinidade.Columns[7].Visible = true;
