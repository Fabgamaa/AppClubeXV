<%@ Page Language="C#" EnableEventValidation="false" AutoEventWireup="true" CodeFile="RelatorioFimDeEvento.aspx.cs" Inherits="_Default"%>
...
Sistema           : FWUNF
Arquivo           : RelatorioFimDeEvento.aspx 
Criado em         : 09/05/2012
Última Alteração  : 
Versão            : 1.00
Descrição         : Módulo para Relatório Fim de Evento
:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
-->
...
<table style="width:780px" align="center" border="0" cellspacing="4" cellpadding="0">
    ...
    <tr>
		<td colspan="2" class="font_body">Maquina</td>
	</tr>
    <tr>
		<td colspan="2">
            <asp:TextBox id="txt_maquina" runat="server" CssClass="text_box" maxlength="10" style="width:100px"></asp:TextBox>
		</td>
	</tr>
    <tr>
    ...
    <tr>
		<td colspan="2">
            <asp:TextBox id="txt_merge" runat="server" CssClass="text_box" maxlength="10" style="width:100px"></asp:TextBox>
		</td>
	</tr>
	<tr>
		<td colspan="2">
