...
public partial class _Default : System.Web.UI.Page
{
	...
	protected void btSalvar_Click(object sender, EventArgs e)
	{
        ...
        {
            TratamentoErro("O campo Título X é obrigatório.");
            txt_tit_inc_xxx.Focus();
            return;
        }
        if (txt_tnc_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Tenacidade X é obrigatório.");
            txt_tnc_inc_xxx.Focus();
            return;
        }
        if (txt_aon_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Alongamento X é obrigatório.");
            txt_aon_inc_xxx.Focus();
            return;
        }
        if (txt_enm_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Encolhimneto X é obrigatório.");
            txt_enm_inc_xxx.Focus();
            return;
        }
        if (txt_eee_inc_xxx.Text == "")
        {
            TratamentoErro("O campo E X é obrigatório.");
            txt_eee_inc_xxx.Focus();
            return;
        }
        if (txt_kkk_inc_xxx.Text == "")
        {
            TratamentoErro("O campo K X é obrigatório.");
            txt_kkk_inc_xxx.Focus();
            return;
        }
        if (txt_bbb_inc_xxx.Text == "")
        {
            TratamentoErro("O campo B X é obrigatório.");
            txt_bbb_inc_xxx.Focus();
            return;
        }
        if (txt_ole_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Óleo X é obrigatório.");
            txt_ole_inc_xxx.Focus();
            return;
        }
        if (txt_ert_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Entrelaçamento X é obrigatório.");
            txt_ert_inc_xxx.Focus();
            return;
        }
        if (txt_rt3_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Retenção 1 X é obrigatório.");
            txt_rt3_inc_xxx.Focus();
            return;
        }
        if (txt_rt5_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Retenção 2 X é obrigatório.");
            txt_rt5_inc_xxx.Focus();
            return;
        }
        if (txt_dnd_inc_xxx.Text == "")
        {
            TratamentoErro("O campo Densidade X é obrigatório.");
        ...
        {
            TratamentoErro("O campo Título Y é obrigatório.");
            txt_tit_inc_yyy.Focus();
            return;
        }
        if (txt_tnc_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Tenacidade Y é obrigatório.");
            txt_tnc_inc_yyy.Focus();
            return;
        }
        if (txt_aon_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Alongamento Y é obrigatório.");
            txt_aon_inc_yyy.Focus();
            return;
        }
        if (txt_enm_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Encolhimneto Y é obrigatório.");
            txt_enm_inc_yyy.Focus();
            return;
        }
        if (txt_eee_inc_yyy.Text == "")
        {
            TratamentoErro("O campo E Y é obrigatório.");
            txt_eee_inc_yyy.Focus();
            return;
        }
        if (txt_kkk_inc_yyy.Text == "")
        {
            TratamentoErro("O campo K Y é obrigatório.");
            txt_kkk_inc_yyy.Focus();
            return;
        }
        if (txt_bbb_inc_yyy.Text == "")
        {
            TratamentoErro("O campo B Y é obrigatório.");
            txt_bbb_inc_yyy.Focus();
            return;
        }
        if (txt_ole_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Óleo Y é obrigatório.");
            txt_ole_inc_yyy.Focus();
            return;
        }
        if (txt_ert_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Entrelaçamento Y é obrigatório.");
            txt_ert_inc_yyy.Focus();
            return;
        }
        if (txt_rt3_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Retenção 1 Y é obrigatório.");
            txt_rt3_inc_yyy.Focus();
            return;
        }
        if (txt_rt5_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Retenção 2 Y é obrigatório.");
            txt_rt5_inc_yyy.Focus();
            return;
        }
        if (txt_dnd_inc_yyy.Text == "")
        {
            TratamentoErro("O campo Densidade Y é obrigatório.");
		...
		if (!string.IsNullOrEmpty(rowId.Value))
		{
			...
			{
				TratamentoErro("Parâmetro Análise alterado com sucesso.");
			}
		}
		else
		{
			...
			//Verificar se já não existe um cadastro consultando o: PRM_ANS_DES 
			PRM_ANS.PRM_ANS_DES = txt_des_inc.Text;
			DataSet dsPRM_ANS = PRM_ANS.Consultar();
			if (dsPRM_ANS.Tables[0].Rows.Count > 0)
			{
				TratamentoErro("Esse ParametroAnalise já está cadastrado.");
				txt_tit_inc.Focus();
            ...
            */ 
			...
			else
			{
				...
				TratamentoErro("Parâmetro Análise inserido com sucesso.");
				if (!string.IsNullOrEmpty(Origem.Value) && Origem.Value == "Novo")
